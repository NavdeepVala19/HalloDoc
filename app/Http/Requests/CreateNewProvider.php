...
class CreateNewProvider extends FormRequest
{
    /**
    ...
    public function messages()
    {
        ...
        return [
            ...
            'password.alpha' => $only_alphabets . ' in Password',
            ...
            'adminNote.required' => $enter . ' Admin Notes',
            'adminNote.max' => $max_message . ' 200 character',
            'adminNote.regex' => 'Please enter alphabets,numbers, hyphens, underscores,fullstop, commas, and forward slashes in admin notes.',
