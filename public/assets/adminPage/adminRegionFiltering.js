...
function fetchPaginatedResults(selectedId, activeStatus, page, search_value, category_value)
{
...
$(document).on("click", ".pagination .page-link", function (event) {
    ...
    fetchPaginatedResults(selectedId, activeStatus,page,search_value,category_value);
});
...
$(".listing-region").on("change", function (event) {
    ...
    var search_value = $(".search-patient").val();
    var category_value = $(".filter-btn.active-filter").attr("data-category");
    fetchPaginatedResults(selectedId,activeStatus,1,search_value,category_value);
});
