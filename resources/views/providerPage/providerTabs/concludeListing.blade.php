    ...
    <div class="listing">
        <div class="search-section d-flex align-items-center  justify-content-between ">
            ...
            <div class="src-category d-flex gap-3 align-items-center">
                <a href="{{ route('provider-listing', ['category' => 'all', 'status' => 'conclude']) }}" class="btn-all filter-btn">All</a>
                <a href="{{ route('provider-listing', ['category' => 'patient', 'status' => 'conclude']) }}" class="d-flex gap-2 filter-btn"> <i class="bi bi-circle-fill green"></i>Patient</a>
                <a href="{{ route('provider-listing', ['category' => 'family', 'status' => 'conclude']) }}" class="d-flex gap-2 filter-btn "> <i class="bi bi-circle-fill yellow"></i>Family/Friend</a>
                <a href="{{ route('provider-listing', ['category' => 'business', 'status' => 'conclude']) }}" class="d-flex gap-2 filter-btn"> <i class="bi bi-circle-fill red"></i>Business</a>
                <a href="{{ route('provider-listing', ['category' => 'concierge', 'status' => 'conclude']) }}" class="d-flex gap-2 filter-btn"> <i class="bi bi-circle-fill blue"></i>Concierge</a>
            </div>
        </div>
