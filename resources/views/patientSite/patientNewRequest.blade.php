        ...
        <form action="{{route('createdPatientRequests')}}" method="post" enctype="multipart/form-data" id="patientNewRequest">
            ...
            <div class="patient-details">
                ...
                <div class="patient-contact-inputs">
                    ...
                    <div class="grid-2">
                        <div class="form-floating" id="form-floating">
                            <input type="email" class="form-control email @error('email') is-invalid @enderror" id="floatingInput4" placeholder="name@example.com" name="email" value="{{ $email }}" disabled>
