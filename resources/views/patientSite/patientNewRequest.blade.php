                    ...
                    <div class="symp-details">
                        ...
                        <div class="form-floating" id="form-floating">
                            <textarea class="form-control note @error('symptoms') is-invalid @enderror" name='symptoms' placeholder="notes"
                                autocomplete="off" id="floatingTextarea2" style="height: 150px">{{ old('symptoms') }}</textarea>
                    ...
                    <div class=" grid-2">
                        ...
                        <div class="form-floating" id="form-floating">
                            <input type="text" name="last_name"
                                ...
                                autocomplete="off" value="" placeholder="Last Name" value="{{ old('last_name') }}">
                        ...
                        <div class="form-floating" id="form-floating">
                            <input type="date"
                                ...
                                autocomplete="off" id="floatingInput3" name="date_of_birth" placeholder="date of birth"
                        ...
                        <div class="grid-2">
                            <div class="form-floating" id="form-floating">
                                <input type="email" class="form-control email @error('email') is-invalid @enderror"
                                    autocomplete="off" id="floatingInput4" placeholder="name@example.com" name="email"
