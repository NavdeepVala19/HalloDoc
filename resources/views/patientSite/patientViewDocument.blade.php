    ...
    <div class="container content">
        ...
        <form action="{{ route('patientViewDocuments') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="container main-content">
                <p>Patient Name</p>
                <p class="user-name">{{ $documents->first()->first_name }} <span
                        class="confirmation-no">{{ $documents->first()->confirmation_no }} </span> </p>
            ...
            <div class="table-content">
                @foreach ($documents as $document)
                    <div class=" patient-content mt-4">
                        ...
                        <a href="{{ route('downloadOne', $document->id) }}" class="primary-empty cloud-down"
