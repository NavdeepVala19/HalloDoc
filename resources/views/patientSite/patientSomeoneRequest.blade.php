            ...
            <div class="patient-details">
                ...
                <div class="symp-details">
                    ...
                    <div class="form-floating" id="form-floating">
                        <textarea class="form-control note @error('symptoms') is-invalid @enderror" name='symptoms' placeholder="notes" id="floatingTextarea2" value="{{ old('symptoms') }}" style="height: 150px"></textarea>
                ...
                <div class=" grid-2">
                    <div class="form-floating" id="form-floating">
                        <input type="text" name="first_name" class="form-control first_name @error('first_name') is-invalid @enderror" id="floatingInput1" value="" placeholder="First Name" value="{{ old('first_name') }}">
                    ...
                    <div class="form-floating" id="form-floating">
                        <input type="text" name="last_name" class="form-control last_name @error('last_name') is-invalid @enderror" id="floatingInput2" value="" placeholder="Last Name" value="{{ old('last_name') }}">
                ...
                <div class="patient-location-inputs">
                    ...
                    <div class="grid-2">
                        ...
                        <div class="form-floating w-100" id="form-floating">
                            <input type="number" name="zipcode" class="form-control zipcode @error('zipcode') is-invalid @enderror" id="floatingInput8" placeholder="Zipcode" value="{{ old('zipcode') }}" min="0">
                ...
                <div class="grid-2">
                    <div class="form-floating" id="form-floating">
                        <input type="text" name="relation" class="form-control relation @error('relation') is-invalid @enderror" id="floatingInput10" placeholder="relation" value="{{ old('relation') }}">
