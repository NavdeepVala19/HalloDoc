    ...
    <div class="patient-container">
        <form action="{{route('createdSomeoneRequests')}}" method="post" enctype="multipart/form-data" id="patientSomeOneRequest">
            ...
            <div class="patient-details">
                ...
                <div class="grid-2">
                    <div class="form-floating ">
                        <input type="text" name="relation" class="form-control relation" id="floatingInput" placeholder="relation" value="{{ old('relation') }}">
                        <label for="floatingInput">Relation with Patient(Optional)</label>
                        @error('relation')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
