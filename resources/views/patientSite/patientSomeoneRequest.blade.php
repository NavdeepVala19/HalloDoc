...
@section('patientSiteContent')
    ...
    <div class="container">
        ...
        <div class="patient-container">
            <form action="{{ route('request.someone.submitted') }}" method="post" enctype="multipart/form-data"
                id="patientSomeOneRequest">
                @csrf
                    ...
                    <div class="symp-details">
                        ...
                        <div class="form-floating" id="form-floating">
                            <textarea class="form-control note @error('symptoms') is-invalid @enderror" name='symptoms' placeholder="notes"
                                autocomplete="off" id="floatingTextarea2" value="{{ old('symptoms') }}" style="height: 150px"></textarea>
                    ...
                    <div class=" grid-2">
                        ...
                        <div class="form-floating" id="form-floating">
                            <input type="text" name="last_name"
                                ...
                                id="floatingInput2" value="" placeholder="Last Name" value="{{ old('last_name') }}">
                        ...
                        <div class="form-floating" id="form-floating">
                            <input type="date"
                                ...
                                id="floatingInput3" autocomplete="off" name="date_of_birth" placeholder="date of birth"
                        ...
                        <div class="grid-2">
                            <div class="form-floating" id="form-floating">
                                <input type="email" class="form-control email @error('email') is-invalid @enderror"
                                    id="floatingInput4" autocomplete="off" placeholder="name@example.com" name="email"
                                    value="{{ old('email') }}">
                            ...
                            <div class="" style="height: 58px;" id="form-floating">
                                <input type="tel" name="phone_number"
                                    ...
                                    autocomplete="off" id="telephone" placeholder="Phone Number"
                        ...
                        <div class="grid-2">
                            ...
                            <div class="form-floating w-100" id="form-floating">
                                <input type="number" name="zipcode"
                                    ...
                                    id="floatingInput8" autocomplete="off" placeholder="Zipcode"
                    ...
                    <div class="grid-2">
                        <div class="form-floating" id="form-floating">
                            <input type="text" name="relation"
                                class="form-control relation @error('relation') is-invalid @enderror"
                                id="floatingInput10" placeholder="relation" autocomplete="off"
                                value="{{ old('relation') }}">
