                    ...
                    <div class="row Concierge-row1">
                        ...
                        <div class="col-md Concierge-col2">
                            <input type="text" placeholder="Your Last Name"
                                class="form-control concierge-last-name-text @error('concierge_last_name') is-invalid @enderror"
                    ...
                    <div class="row Concierge-row2">
                        <div class="col-md Concierge-col1">
                            <input type="tel" placeholder="Mobile Number"
                                class="form-control concierge-mobile-text @error('concierge_mobile') is-invalid @enderror"
                        ...
                        <div class="col-md Concierge-col2">
                            <input type="email" placeholder="Your Email"
                                class="form-control concierge-email-text @error('concierge_email') is-invalid @enderror"
                    ...
                    <div class="row Concierge-row3">
                        ...
                        <div class="col-md Concierge-col3 me-4">
                            <input type="text" placeholder="Hotel/Property Name" name="concierge_hotel_name"
                                class="form-control hotel-text w-50 @error('concierge_hotel_name') is-invalid @enderror"
                    ...
                    <div class="row patient-location-row1">
                        <div class="col-md patient-location-col1">
                            <input type="text" placeholder="Street"
                                class="form-control patient-location-street-text @error('concierge_street') is-invalid @enderror"
                        ...
                        <div class="col-md patient-location-col2">
                            <input type="text" placeholder="City"
                                class="form-control patient-location-city-text @error('concierge_city') is-invalid @enderror"
                    ...
                    <div class="row patient-location-row2">
                        <div class="col-md patient-location-col1">
                            <input type="text" placeholder="State"
                                class="form-control patient-location-state-text @error('concierge_state') is-invalid @enderror"
                        ...
                        <div class="col-md patient-location-col2">
                            <input type="text" placeholder="Zip Code"
                                class="form-control patient-location-zipcode-text @error('concierge_zip_code') is-invalid @enderror"
                    ...
                    <div class="symp-details">
                        ...
                        <div class="area-text">
                            <div class="form-floating">
                                <textarea class="form-control text-area-box" placeholder="Leave a comment here" name="symptoms" id="floatingTextarea3"
                    ...
                    <div class="row patient-details-row1">
                        <div class="col-md patient-details-col1">
                            <input type="text" placeholder="FirstName"
                                class="form-control first-name-text @error('first_name') is-invalid @enderror"
                        ...
                        <div class="col-md patient-details-col2">
                            <input type="text" placeholder="LastName"
                                class="form-control last-name-text @error('last_name') is-invalid @enderror"
