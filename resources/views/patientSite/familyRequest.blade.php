                    ...
                    <div class="row family-row1">
                        <div class="col-md family-col1 patient">
                            <input type="text" placeholder="Your First Name"
                                ...
                                value="{{ old('family_first_name') }}" name="family_first_name">
                    ...
                    <div class="row family-row2">
                        <div class="col-md family-col1 patient">
                            <input type="text" placeholder="Mobile No"
                                class="form-control family-mobile-text @error('family_phone_number') is-invalid @enderror"
                                name="family_phone_number" value="{{ old('family_phone_number') }}" id=""
                        ...
                        <div class="col-md family-col2 patient">
                            <input type="email" placeholder="Your Email"
                                ...
                                name="family_email" id="" value="{{ old('family_email') }}"
                                aria-describedby="emailHelp">
                            @error('family_email')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row family-row3">
                        ...
                        <div class="col-md family-col3 me-4 patient">
                            <input type="text" placeholder="Relation with Patient" name="family_relation"
                                ...
                                value="{{ old('family_relation') }}" id="family_relation">
                        ...
                        <div class="area-text">
                            <div class="form-floating">
                                <textarea class="form-control text-area-box" placeholder="Leave a comment here" name="symptoms"
                                    value="{{ old('symptoms') }}" id="floatingTextarea3" style="height: 150px"></textarea>
                    ...
                    <div class="row patient-details-row1">
                        <div class="col-md patient-details-col1 patient">
                            <input type="text" placeholder="FirstName"
                                ...
                                id="" value="{{ old('first_name') }}" aria-describedby="helpId" name="first_name">
                            @error('first_name')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md patient-details-col2 patient">
                            <input type="text" placeholder="LastName"
                                ...
                                value="{{ old('last_name') }}" aria-describedby="helpId" name="last_name">
                            @error('last_name')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row patient-details-row2">
                        ...
                        <div class="col-md patient-details-col3 me-4 patient">
                            ...
                            <input type="date" placeholder="Date-Of-Birth"
                                class="form-control date-of-birth w-50 @error('date_of_birth') is-invalid @enderror"
                                id="" value="{{ old('date_of_birth') }}" name="date_of_birth">
                            @error('date_of_birth')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row patient-contact-row1">
                            <div class="col-md patient-contact-col1 patient">
                                <input type="email" placeholder="Email"
                                    ...
                                    value="{{ old('email') }}" aria-describedby="helpId" name="email">
                                @error('email')
                            ...
                            <div class="col-md patient-contact-col2 patient">
                                <input type="tel" placeholder="Mobile No"
                                    class="form-control mobile-text @error('phone_number') is-invalid @enderror"
                                    id="" value="{{ old('phone_number') }}" aria-describedby="helpId"
                                    name="phone_number">
                                @error('phone_number')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row patient-location-row3">
                            <div class="col-md patient-location-col3 me-4">
                                <input type="number" placeholder="Room/Suite(optional)" name="room"
                                    class="form-control patient-location-room-text w-50  " id="room" name="room"
                                    value="{{ old('room') }}">
                            </div>
