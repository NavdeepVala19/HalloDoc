                ...
                <div class="patient-details">
                    ...
                    <div class="symp-details">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control note" name='symptoms' placeholder="notes" id="floatingTextarea2"
                                value="{{ old('symptoms') }}" style="height: 150px"></textarea>
                    ...
                    <div class="buttons">
                        <button class="primary-fill me-2" type="submit"> <i
                                class="loading-spinner fa fa-lg fas fas-spinner fa-spin"></i> Submit</button>
