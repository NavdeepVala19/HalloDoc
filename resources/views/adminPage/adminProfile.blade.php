                ...
                <div class="grid-2">
                    <div class="form-floating ">
                        <input type="text" name="user_name" class="form-control" id="floatingInput"
                            placeholder="User Name" value="{{ $adminProfileData->users->username }}">
                        <label for="floatingInput">User Name</label>
                    </div>

                    <div class="form-floating ">
                        <input type="password" name="password" class="form-control" id="floatingInput"
                            placeholder="password" value="{{ $adminProfileData->users->password }}">
                ...
                <div class="grid-2">
                    <div class="form-floating ">
                        <input type="text" name="first_name" class="form-control" id="floatingInput"
                            placeholder="First Name" value="{{ $adminProfileData->first_name }}">
                    ...
                    <div class="form-floating ">
                        <input type="text" name="last_name" class="form-control" id="floatingInput"
                            placeholder="Last Name" value="{{ $adminProfileData->last_name }}">
                    ...
                    <div class="form-floating ">
                        <input type="email" class="form-control" id="floatingInput" name="email"
                            placeholder="name@example.com" value="{{ $adminProfileData->email }}">
                        <label for="floatingInput">Email</label>
                    </div>

                    <div class="form-floating ">
                        <input type="email" class="form-control" id="floatingInput" name="confirm-email"
                            placeholder="name@example.com" value="{{ $adminProfileData->email }}">
                        <label for="floatingInput">Confirm Email</label>
                    </div>

                    <input type="tel" name="phone_number" class="form-control phone" id="telephone"
                        placeholder="Phone Number" value="{{ $adminProfileData->mobile }}">
                    @error('phone_number')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="grid-2">
                    ...
                    <div class="form-floating ">
                        <input type="text" name="zip" class="form-control" id="floatingInput" placeholder="zip"
                            value="{{ $adminProfileData->zip }}">
                        <label for="floatingInput">Zip</label>
                    </div>
                    <input type="tel" name="alt_mobile" class="form-control phone" id="telephone"
                        placeholder="mobile" value="{{ $adminProfileData->alt_phone }}">
                    @error('mobile')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
