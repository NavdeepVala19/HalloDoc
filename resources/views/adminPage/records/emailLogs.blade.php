        ...
        <form action="{{ route('search.filter.email') }}" method="get">
            ...
            <div class="grid-6 email-search-box">
                <div class="form-floating">
                    <select name="role_id" class="form-select empty-fields" id="floatingSelect" aria-label="Floating label select example">
                ...
                <div class="form-floating ">
                    <input type="text" name="receiver_name" class="form-control empty-fields" id="floatingInput" placeholder="Receiver Name" value="@if (isset($receiverName)) {{ $receiverName }} @endIf">
                    <label for="floatingInput">Receiver Name</label>
                </div>
                <div class="form-floating ">
                    <input type="email" name="email" class="form-control empty-fields" id="floatingInput" placeholder="name@example.com" value="@if (isset($email)) {{ $email }} @endIf">
                    <label for="floatingInput">Email Id</label>
                </div>
                <div class="form-floating ">
                    <input type="date" name="created_date" class="form-control empty-fields" id="floatingInput" placeholder="Created Date" value=@if (isset($createdDate)) {{ $createdDate }} @endIf>
                    <label for="floatingInput">Created Date</label>
                </div>
                <div class="form-floating ">
                    <input type="date" name="sent_date" class="form-control empty-fields" id="floatingInput" placeholder="Sent Date" value=@if (isset($sentDate)) {{ $sentDate }} @endIf>
