...
@section('content')
    <div class="container form-container">
        ...
        <div class="section">
            <form action="{{ route('admin.created.provider') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid-3">
                    <div class="form-floating provider-form">
                        <input type="text" name="user_name" class="form-control @error('user_name') is-invalid @enderror"
                            id="floatingInput1" autocomplete="off" placeholder="User Name" value="{{ old('user_name') }}">
                    ...
                    <div class="form-floating provider-form">
                        <input type="password" name="password" class="form-control @error('password') is-invalid @enderror"
                            id="floatingInput2" autocomplete="off" placeholder="password" value="{{ old('password') }}"
                            autocomplete="on">
                ...
                <div class="grid-2">
                    <div class="form-floating provider-form">
                        <input type="text" name="first_name"
                            class="form-control @error('first_name') is-invalid @enderror" id="floatingInput3"
                    ...
                    <div class="form-floating provider-form">
                        <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror"
                            id="floatingInput4" autocomplete="off" placeholder="Last Name"
                            value="{{ old('last_name') }}">
                    ...
                    <div class="form-floating provider-form">
                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                            id="floatingInput5" placeholder="name@example.com" autocomplete="off" name="email"
                            value="{{ old('email') }}">
                    ...
                    <div class="form-floating provider-form">
                        <input type="number" name="medical_license"
                            class="form-control @error('medical_license') is-invalid @enderror" autocomplete="off"
                            id="floatingInput6" placeholder="Medical License" value="{{ old('medical_license') }}"
                            min="0">
                    ...
                    <div class="form-floating provider-form">
                        <input type="number" name="npi_number"
                            class="form-control @error('npi_number') is-invalid @enderror" id="floatingInput7"
                            autocomplete="off" placeholder="NPI Number" value="{{ old('npi_number') }}" min="0">
                    ...
                    <div class="d-flex gap-4 flex-wrap provider-form">
                        @foreach ($regions as $region)
                            <div class="form-check">
                                <input class="form-check-input region-checkbox" type="checkbox" name="region_id[]"
                                    id="region_{{ $region->id }}" autocomplete="off" value="{{ $region->id }}"
                ...
                <div class="grid-2">
                    <div class="form-floating provider-form">
                        <input type="text" name="address1"
                            class="form-control @error('address1') is-invalid @enderror" id="floatingInput8"
                            autocomplete="off" placeholder="Address 1" value="{{ old('address1') }}">
                    ...
                    <div class="form-floating provider-form">
                        <input type="text" name="address2"
                            class="form-control @error('address2') is-invalid @enderror" id="floatingInput9"
                            autocomplete="off" placeholder="Address 2" value="{{ old('address2') }}">
                    ...
                    <div class="form-floating provider-form">
                        <input type="text" name="city" class="form-control @error('city') is-invalid @enderror"
                            id="floatingInput10" autocomplete="off" placeholder="city" value="{{ old('city') }}">
                    ...
                    <div>
                        <div class="form-floating provider-form">
                            <select class="form-select @error('select_state') is-invalid @enderror" id="floatingSelect"
                                autocomplete="off" aria-label="Floating label select example" name="select_state"
                                value="{{ old('select_state') }}">
                    ...
                    <div class="form-floating provider-form">
                        <input type="number" name="zip" class="form-control @error('zip') is-invalid @enderror"
                            autocomplete="off" id="floatingInput11" placeholder="zip" value="{{ old('zip') }}"
                            min="0">
                    ...
                    <div class="provider-form" style="height: 58px;">
                        <input type="number" name="phone_number_alt"
                            class="form-control phone @error('phone_number_alt') is-invalid @enderror" id=""
                            placeholder="Phone Number" autocomplete="off" value="{{ old('phone_number_alt') }}"
                            min="0">
                ...
                <div class="grid-2">
                    <div class="form-floating provider-form">
                        <input type="text" name="business_name"
                            class="form-control @error('business_name') is-invalid @enderror" autocomplete="off"
                            id="floatingInput12" placeholder="Business Name" value="{{ old('business_name') }}">
                    ...
                    <div class="form-floating provider-form">
                        <input type="url" name="business_website"
                            class="form-control @error('business_website') is-invalid @enderror" autocomplete="off"
                            id="floatingInput13" placeholder="Business Website" value="{{ old('business_website') }}">
                ...
                <div class="form-floating provider-form">
                    <textarea class="form-control @error('admin_notes') is-invalid @enderror" autocomplete="off"
                        placeholder="Admin_Notes" id="floatingTextarea2" name="admin_notes" style="height: 120px">{{ old('admin_notes') }}</textarea>
                        ...
                        <table>
                            <tbody>
                                    ...
                                    <td>
                                        <div class="ms-4 btns provider-form">
                                            <label for="independent_contractor" class="upload primary-fill"> <i
                                                    class="bi bi-cloud-arrow-up"></i> <span
                                ...
                                <tr class="border-bottom-table">
                                    ...
                                    <td>
                                        <div class="ms-4 btns provider-form">
                                            <label for="background-input" class="upload primary-fill"> <i
                                                    class="bi bi-cloud-arrow-up"></i> <span
                                                    class="upload-txt">Upload</span> </label>
                                ...
                                <tr class="border-bottom-table">
                                    ...
                                    <td>
                                        <div class="ms-4 btns provider-form">
                                            <label for="hipaa-input" class="upload primary-fill"> <i
                                                    class="bi bi-cloud-arrow-up"></i> <span
                                                    class="upload-txt">Upload</span> </label>
                                ...
                                <tr class="border-bottom-table">
                                    ...
                                    <td>
                                        <div class="ms-4 btns provider-form">
                                            <label for="non-disclosure-input" class="upload primary-fill"> <i
                                                    class="bi bi-cloud-arrow-up"></i> <span
                                                    class="upload-txt">Upload</span> </label>
