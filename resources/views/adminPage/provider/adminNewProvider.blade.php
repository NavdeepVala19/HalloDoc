        ...
        <form action="{{ route('adminCreateNewProvider') }}" method="POST" enctype="multipart/form-data" id="createAdminProvider">
            ...
            <div class="grid-3">
                <div class="form-floating ">
                    <input type="text" name="user_name" class="form-control @error('user_name') is-invalid @enderror" id="floatingInput" placeholder="User Name" value="{{ old('user_name') }}">
                ...
                <div class="form-floating ">
                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="floatingInput" placeholder="password" value="{{ old('password') }}">
            ...
            <div class="grid-2">
                ...
                <div class="form-floating ">
                    <input type="number" name="medical_license" class="form-control @error('medical_license') is-invalid @enderror" id="floatingInput" placeholder="Medical License" value="{{ old('medical_license') }}">
                ...
                <div class="form-floating">
                    <input type="number" name="npi_number" class="form-control @error('npi_number') is-invalid @enderror" id="floatingInput" placeholder="NPI Number" value="{{ old('npi_number') }}">
            ...
            <div class="grid-2">
                ...
                <div class="form-floating ">
                    <input type="text" name="address1" class="form-control @error('address1') is-invalid @enderror" id="floatingInput" placeholder="Address 1" value="{{ old('address1') }}">
                ...
                <div class="form-floating ">
                    <input type="text" name="address2" class="form-control @error('address2') is-invalid @enderror" id="floatingInput" placeholder="Address 2" value="{{ old('address2') }}">
                ...
                <div class="form-floating ">
                    <input type="number" name="zip" class="form-control @error('zip') is-invalid @enderror" id="floatingInput" placeholder="zip" value="{{ old('zip') }}">
                ...
                <div style="height: 58px;">
                    <input type="tel" name="phone_number_alt" class="form-control phone @error('phone_number_alt') is-invalid @enderror" id="telephone" value="{{ old('phone_number_alt') }}">
            ...
            <div class="grid-2">
                ...
                <div class="form-floating ">
                    <input type="text" name="business_name" class="form-control @error('business_name') is-invalid @enderror" id="floatingInput" placeholder="Business Name" value="{{ old('business_name') }}">
