        ...
        <div class="section">
            ...
            <form action="{{ route('adminUpdatedProvider', $getProviderData->id) }}" method="POST">
                ...
                <div class="grid-2">
                    ...
                    <div class="form-floating ">
                        <input type="password" name="password" class="form-control provider-password-field"
                            id="floatingInput" value="{{ $getProviderData->users->password }}" placeholder="password"
                            disabled>
                ...
                <div class="grid-2">
                    ...
                    <div class="form-floating ">
                        <input type="text" name="first_name" class="form-control provider-firstname" id="floatingInput"
                            value="{{ $getProviderData->first_name }}" placeholder="First Name" disabled>
                    ...
                    <div class="form-floating ">
                        <input type="text" name="last_name" class="form-control provider-lastname" id="floatingInput"
                            placeholder="Last Name" value="{{ $getProviderData->last_name }}" disabled>
                    ...
                    <div class="form-floating ">
                        <input type="email" class="form-control provider-alt-email" id="floatingInput"
                            placeholder="name@example.com" value="{{ $getProviderData->syncEmailAddress }}"
                            name="alt_email" disabled>
                        <label for="floatingInput">Email</label>
                    </div>
                ...
                <div class="grid-2">
                    ...
                    <div class="form-floating ">
                        <input type="text" name="address1" class="form-control provider-bill-add1" id="floatingInput"
                            placeholder="Address 1" value="{{ $getProviderData->address1 }}" disabled>
                        <label for="floatingInput">Address 1</label>
                    </div>

                    <div class="form-floating ">
                        <input type="text" name="address2" class="form-control provider-bill-add2" id="floatingInput"
                            placeholder="Address 2" value="{{ $getProviderData->address2 }}" disabled>
                        <label for="floatingInput">Address 2</label>
                    </div>

                    <div class="form-floating ">
                        <input type="text" name="city" class="form-control provider-bill-city" id="floatingInput"
                            placeholder="city" value="{{ $getProviderData->city }}" disabled>
                    ...
                    <div class="form-floating ">
                        <input type="text" name="zip" class="form-control provider-bill-zip" id="floatingInput"
                            placeholder="zip" value="{{ $getProviderData->zip }}" disabled>
                        <label for="floatingInput">Zip</label>
                    </div>

                    <input type="tel" name="alt_phone_number" class="form-control phone alt-phone-provider"
                        id="telephone" value="{{ $getProviderData->alt_phone }}" placeholder="Phone Number" disabled>
                    @error('phone_number')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                            ...
                            <tbody>
                                ...
                                <tr class="border-bottom-table">
                                    <td>
                                        <div class="d-flex gap-2 align-items-center">
                                            <input class="form-check-input" type="checkbox" value=""
                                                id="flexCheckDefault" name="license_check"
