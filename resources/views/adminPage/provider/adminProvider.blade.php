                    ...
                    @foreach ($providersData as $data)
                        ...
                        <div class="mobile-listing">
                            @foreach ($providersData as $data)
                                <div class="mobile-list">
                                    <div class="main-section mt-3">
                                        <h5 class="heading"> <input class="form-check-input" type="checkbox"
                                                value="" id="checkbox"> {{ $data->first_name }}</h5>
                                        <div class="detail-box">
                                            <span>
                                                On Call Status: <strong>Available</strong>
                                            </span>
                            ...
                            <div class="pop-up new-provider-pop-up">
                                ...
                                <div class="ms-3">
                                    ...
                                    <form action="{{ route('sendMailToProvider', $data->id) }}" method="post"
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="contact" value="sms"
                                                checked id="flexRadioDefault">
                                            <label class="form-check-label" for="flexRadioDefault">
                                                SMS
                                            </label>
                                        </div>
