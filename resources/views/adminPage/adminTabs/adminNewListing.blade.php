...
<div class="main">
    ...
    <div class="listing">
        <div class="search-section d-flex align-items-center  justify-content-between ">
            <form action="{{ route('searching', ['status' => 'new', 'category' => request('category', 'all')]) }}" method="GET" class="d-flex align-items-center filter-section">
                {{-- @csrf --}}
                ...
                <div>
                    ...
                    <div class="grid-2-listing">
                        <button class="secondary-btn-5 text-center assign-case-btn" data-id={{ $case->id }}>Assign
                            Case</button>
                        <button data-id="{{ $case->id }}" data-patient_name="{{ $case->requestClient->first_name }} {{ $case->requestClient->last_name }}" class="secondary-btn-4 text-center cancel-case-btn">Cancel
                            Case</button>
                        <a href="{{ route('admin.view.note', $case->id) }}" class="secondary-btn text-center">View
                            Notes</a>
                        <button data-id="{{ $case->id }}" data-patient_name="{{ $case->requestClient->first_name }} {{ $case->requestClient->last_name }}" class="secondary-btn-4 text-center block-case-btn">Block
                            Patient</button>
