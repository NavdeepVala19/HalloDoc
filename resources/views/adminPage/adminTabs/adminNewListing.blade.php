...
<div class="pop-up assign-case">
    ...
    <form action="{{ route('admin.assign.case') }}" method="POST">
        ...
        <div class="m-3">
            ...
            <div class="form-floating">
                <select class="form-select selectPhysician" name="physician" id="floatingSelect" aria-label="Floating label select example">
                            ...
                            <div class="action-container">
                                ...
                                <div class="action-menu">
                                    ...
                                    <button><i class="bi bi-journal-arrow-down me-2 ms-3"></i>View
                                        Case</button>
                                    <a href="/view-notes/{{ $case->request->id }}"><i class="bi bi-journal-text me-2 ms-3"></i>View Notes</a>
