    ...
    <form action="{{ route('admin.cancel.case') }}" method="POST">
        ...
        <div class="m-3">
            <div class="form-floating">
                <select class="form-select" name="case_tag" class="cancel-options" id="floatingSelect" aria-label="Floating label select example">
...
<div class="pop-up assign-case">
    ...
    <form action="{{ route('admin.assign.case') }}" method="POST">
        ...
        <div class="m-3">
            ...
            <div class="form-floating">
                <select class="form-select selectPhysician @error('physician')
                    is-invalid
                    @enderror" name="physician" id="floatingSelect" aria-label="Floating label select example" required>
    ...
    <div class="listing">
        <div class="search-section d-flex align-items-center  justify-content-between ">
            ...
            <div class="src-category d-flex gap-3 align-items-center">
                <a href="{{ route('admin.listing', ['category' => 'all', 'status' => 'new']) }}" data-category="all" class="btn-all filter-btn">All</a>
                <a href="{{ route('admin.listing', ['category' => 'patient', 'status' => 'new']) }}" data-category="patient" class="d-flex gap-2 filter-btn"> <i class="bi bi-circle-fill green"></i>Patient</a>
                <a href="{{ route('admin.listing', ['category' => 'family', 'status' => 'new']) }}" data-category="family" class="d-flex gap-2 filter-btn"> <i class="bi bi-circle-fill yellow"></i>Family/Friend</a>
                <a href="{{ route('admin.listing', ['category' => 'business', 'status' => 'new']) }}" data-category="business" class="d-flex gap-2 filter-btn"> <i class="bi bi-circle-fill red"></i>Business</a>
                <a href="{{ route('admin.listing', ['category' => 'concierge', 'status' => 'new']) }}" data-category="concierge" class="d-flex gap-2 filter-btn"> <i class="bi bi-circle-fill blue"></i>Concierge</a>
            </div>
        </div>
                        ...
                        <td>
                            <div class="action-container">
                                ...
                                <div class="action-menu">
                                    <button class="assign-case-btn" data-id="{{ $case->request->id }}"><i class="bi bi-journal-check me-2 ms-3"></i>Assign Case</button>
                                    <button class="cancel-case-btn" data-id="{{ $case->request->id }}" data-patient_name="{{ $case->request->requestClient->first_name }} {{ $case->request->requestClient->last_name }}"><i class="bi bi-x-circle me-2 ms-3"></i>Cancel
                                        Case</button>
                                    <a href="{{ route('admin.view.case', $case->request->id) }}"><i class="bi bi-journal-arrow-down me-2 ms-3"></i>View
                                        Case</a>
                                    <a href="{{ route('admin.view.note', $case->request->id) }}"><i class="bi bi-journal-text me-2 ms-3"></i>View Notes</a>
                                    <button class="block-case-btn" data-id="{{ $case->request->id }}" data-patient_name="{{ $case->request->requestClient->first_name }} {{ $case->request->requestClient->last_name }}">
