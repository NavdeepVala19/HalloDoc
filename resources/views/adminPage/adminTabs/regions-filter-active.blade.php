     ...
     <td>
         <div class="action-container">
             ...
             <div class="actions-menubar">
                 <a href="{{ route('provider.view.case', $case->request_id) }}"><i class="bi bi-journal-arrow-down me-2 ms-3"></i>View
                     Case</a>
                 <a href="{{ route('provider.view.upload', ['id' => $case->request_id]) }}"><i class="bi bi-file-earmark-arrow-up-fill me-2 ms-3"></i>View
                     Uploads</a>
